...
contract PupolMain is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor(uint256 _bonusPerPupol, uint256 _bonusAllocation)
        payable
        ERC721("Pupol NFT", "PUPOL")
        Ownable(msg.sender)
    {
    ...
    function transferPupol(address _from, address _to, uint256 _pupolId) public {
    ...
    function _finalCheckBeforeTransfer(address _from, address _to) internal {
